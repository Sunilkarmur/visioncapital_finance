...
Route::group(['middleware' => 'auth'], function () {
    ...
    // Emi Installment
    Route::get('/emi/{account_id}',[\App\Http\Controllers\EmiInstallmentController::class,'index'])->name('emi.index');
    Route::get('/emi/list/{account_id}',[\App\Http\Controllers\EmiInstallmentController::class,'show'])->name('emi.list');
