            ...
            <div class="widget-content widget-content-area">
              <div id="pill-vertical">
                    ...
                    <div class="form-group row  mb-4 d-none select_affiliate_type">
                      ...
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm ref_affiliate_type" name="ref_affiliate_type[]"
                          id="ref_affiliate_type" multiple="multiple">
                    ...
                    <div class="row">
                      <div class="col-12">
                        <a href="javascript:void(0);"
                          class="btn btn-outline-primary mb-2 float-right add_business_details" type="button">Add</a>
                      </div>
                    </div>
                    <div class="business_details_row">
                      <form class="business_detail_form">
                        <div class="form-group row  mb-4">
                          <div class="col-12">
                            <a href="javascript:void(0);"
                              class="btn btn-outline-danger mb-2 float-right remove_business_details_btn d-none"
                        ...
                        <div class="form-group promoter_name_row d-none row  mb-4">
                          ...
                          <div class="col-sm-8">
                            <input type="text" name="promoter_name" class="form-control form-control-sm"
                              id="promoter_name" placeholder="Main Promoter Name">
                          </div>
                        </div>
                        <div class="form-group row  mb-4">
                ...
                <section>
                  <div class="row">
                    <div class="col-12">
                      <a href="javascript:void(0);" class="btn btn-outline-primary mb-2 float-right add_banking_finance"
                        type="button">Add</a>
                    </div>
                  </div>
                  <div class="banking_finance_row">
                    <form class="banking_finance_form">
                      <div class="form-group row  mb-4">
                        <div class="col-12">
                          <a href="javascript:void(0);"
                            class="btn btn-outline-danger mb-2 float-right remove_banking_finance_btn d-none"
                            type="button">Remove</a>
                        </div>
                      </div>
                      <div class="form-group row  mb-4">
                      ...
                      <div class="link_loan_type">
                        ...
                        <div class="form-group row  mb-4">
                          <label for="bank_balance" class="col-sm-4 col-form-label col-form-label-sm">Outstanding
                            Amount</label>
                          <div class="col-sm-8">
                            <input type="text" name="bank_balance" class="form-control form-control-sm"
                              id="bank_balance" placeholder="Balance Amount">
                          </div>
                        </div>
                        <div class="form-group row  mb-4">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <a href="javascript:void(0);" class="btn btn-outline-primary mb-2 float-right add_current_ac_btn"
                        type="button">Add Current Account</a>
                      <a href="javascript:void(0);"
                        class="btn btn-outline-primary mb-2 float-right add_saving_ac_btn mr-2" type="button">Add Saving
                        Account</a>
                    </div>
                  </div>
                  <div class="saving_ac_row">
                    <form class="saving_ac_bank_form">
                      <div class="form-group row  mb-4">
                        <div class="col-12">
                          <a href="javascript:void(0);"
                            class="btn btn-outline-danger mb-2 float-right remove_saving_ac_btn d-none"
                            type="button">Remove</a>
                        </div>
                      </div>
                      <div class="form-group row  mb-4">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="saving_ac_bank" class="form-control form-control-sm"
                            id="saving_ac_bank" placeholder="Savings Account Bank">
                        </div>
                      </div>
                      <div class="form-group row  mb-4">
                  ...
                  <div class="current_account_row">
                    <form class="current_ac_bank_form">
                      <div class="form-group row  mb-4">
                        <div class="col-12">
                          <a href="javascript:void(0);"
                            class="btn btn-outline-danger mb-2 float-right remove_current_ac_btn d-none"
                            type="button">Remove</a>
                        </div>
                      </div>
                      <div class="form-group row  mb-4">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="current_ac_bank" class="form-control form-control-sm"
                            id="current_ac_bank" placeholder="Current Account Bank">
                        </div>
                      </div>
                      <div class="form-group row  mb-4">
                ...
                <section>
                  <div class="form-group row  mb-4">
                    <div class="col-12">
                      <a href="javascript:void(0);" class="btn btn-outline-primary mb-2 float-right add_gaurantor"
                        type="button">Add</a>
                  ...
                  <div class="guarantor_section">
                    <form class="guarantor_section_form">
                      <div class="form-group row  mb-4">
                        <div class="col-12">
                          <a href="javascript:void(0);"
                            class="btn btn-outline-danger mb-2 float-right remove_gaurantor d-none"
                            type="button">Remove</a>
                        </div>
                      </div>
                      <div class="form-group row  mb-4">
...
$(document).ready(function() {
  ...
  $('#bor_mob_no').inputmask("9999999999");
