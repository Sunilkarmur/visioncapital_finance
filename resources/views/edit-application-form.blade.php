          ...
          <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
              <div id="pill-vertical">
                    ...
                    <div class="form-group row  mb-4">
                      ...
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm ref_affiliate_vc" name="ref_affiliate_vc">
                          <option value="Yes" {{ $finance->ref_affiliate_vc==="Yes"?"selected='selected'":"" }}>Yes
                          </option>
                          <option value="No" {{ $finance->ref_affiliate_vc==="No"?"selected='selected'":"" }}>No
                          </option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row  mb-4 d-none select_affiliate_type">
                      <label for="ref_affiliate_type" class="col-sm-4 col-form-label col-form-label-sm">Select Affliated
                        Type</label>
                      <div class="col-sm-8">
                    ...
                    <div class="form-group row  mb-4">
                      ...
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm bor_affiliate_vc" name="bor_affiliate_vc">
                          <option value="Yes" {{ $finance->bor_affiliate_vc==='Yes'?'selected="selected"':'' }}>Yes
                          </option>
                          <option value="No" {{ $finance->bor_affiliate_vc==='No'?'selected="selected"':'' }}>No
                          </option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row  mb-4 d-none bor_select_affiliate_type">
                      ...
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm bor_affiliate_type" name="bor_affiliate_type">
                          <option value="Loan" {{ $finance->bor_affiliate_type==='Loan'?'selected="selected"':'' }}>Loan
                          </option>
                          <option value="Subsidy"
                            {{ $finance->bor_affiliate_type==='Subsidy'?'selected="selected"':'' }}>Subsidy</option>
                          <option value="Finance"
                            {{ $finance->bor_affiliate_type==='Finance'?'selected="selected"':'' }}>Finance</option>
                          <option value="VC" {{ $finance->bor_affiliate_type==='VC'?'selected="selected"':'' }}>VC
                          </option>
                  ...
                  <div id="business_details">
                    ...
                    <div class="business_details_clone_row">
                      ...
                      <form class="business_detail_form">
                        ...
                        <div class="form-group row  mb-4">
                          <label for="business_name" class="col-sm-4 col-form-label col-form-label-sm">Name of
                            Firm</label>
                          <div class="col-sm-8">
                        ...
                        <div class="form-group promoter_name_row d-none row  mb-4">
                          <label for="business_nature" class="col-sm-4 col-form-label col-form-label-sm">Main Promoter
                            Name</label>
                          <div class="col-sm-8">
                        ...
                        <div class="form-group row  mb-4">
                          <label for="total_no_machines" class="col-sm-4 col-form-label col-form-label-sm">Total no. of
                            Machines</label>
                          <div class="col-sm-8">
                        ...
                        <div class="form-group row  mb-4">
                          <label for="total_no_employees" class="col-sm-4 col-form-label col-form-label-sm">Total no. of
                            Employees</label>
                          <div class="col-sm-8">
                        ...
                        <div class="form-group row  mb-4">
                          <label for="business_location_type"
                            class="col-sm-4 col-form-label col-form-label-sm">Ownership Type</label>
                          <div class="col-sm-8">
                        ...
                        <div class="form-group row  mb-4">
                          <label for="business_duration_place"
                            class="col-sm-4 col-form-label col-form-label-sm">Duration at that place:</label>
                          <div class="col-sm-8">
                    ...
                    <div class="form-group row  mb-4">
                      ...
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm home_type" name="home_type">
                          ...
                          <option value="Rented" selected="{{ $finance->home_type==="Rented"?'selected':'' }}">Rented
                          </option>
                        </select>
                      </div>
                    </div>
                      ...
                      <div class="form-group row  mb-4">
                        ...
                        <div class="col-sm-8">
                          <select name="previous_lona_type" class="form-control form-control-sm previous_lona_type">
                            <option value="1" selected={{ $value->previous_lona_type==='1'?"selected":'selected' }}>Home
                              Loan</option>
                            ...
                            <option value="4" selected={{ $value->previous_lona_type==='4'?"selected":'selected' }}>
                              Machinary Loan</option>
                            <option value="5" selected={{ $value->previous_lona_type==='5'?"selected":'selected' }}>
                              Vehicle Loan</option>
                            <option value="6" selected={{ $value->previous_lona_type==='6'?"selected":'selected' }}>Gold
                              Loan</option>
                            <option value="7" selected={{ $value->previous_lona_type==='7'?"selected":'selected' }}>CC
                              Loan</option>
                          </select>
                        </div>
                      </div>
                ...
                <section>
                  ...
                  <div class="guarantor_section">
                    ...
                    <form class="guarantor_section_form">
                      ...
                      <div class="form-group row  mb-4">
                        <label for="guarantor_name" class="col-sm-4 col-form-label col-form-label-sm">Name of
                          Person</label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group row  mb-4">
                        <label for="guarantor_firm" class="col-sm-4 col-form-label col-form-label-sm">Name of
                          Firm</label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group row  mb-4">
                        ...
                        <div class="col-sm-8">
                          <select class="form-control form-control-sm guarantor_affiliate_vc"
                            ...
                            <option value="1" selected="{{ $value->guarantor_affiliate_vc==='1'?'selected':'' }}">Yes
                            </option>
                            <option value="0" selected="{{ $value->guarantor_affiliate_vc==='0'?'selected':'' }}">No
                            </option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group row  mb-4 d-none guarantor_specify">
                        <label for="guarantor_affiliate_type_other"
                          class="col-sm-4 col-form-label col-form-label-sm">Specify here</label>
                        <div class="col-sm-8">
                ...
                @if(!empty($finance->officeUse))
                @php $office = $finance->officeUse; @endphp
                @endif
                @if($office)
                <section>
                  <form class="officeuse_section_form">
                    <div class="form-group row  mb-4 remarks">
                      <label for="guarantor_affiliate_type_other"
                        class="col-sm-4 col-form-label col-form-label-sm">Remarks</label>
                      <div class="col-sm-8">
                        <textarea name="remarks" class="form-control form-control-sm" id="remarks"
                          placeholder="Remarks">{{ $office->remark }}</textarea>
                      </div>
                    </div>
                    <div class="form-group row  mb-4 cibil_score">
                      <label for="guarantor_affiliate_type_other"
                        class="col-sm-4 col-form-label col-form-label-sm">CIBIL
                        Score
                        Required?</label>
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm cibil_score_required_type"
                          name="cibil_score_required_type">
                          <option value="1" @if($office->cibil_score_required_type == '1') selected @endif>Yes</option>
                          <option value="0" @if($office->cibil_score_required_type == '0') selected @endif>No</option>
                        </select>
                      </div>
                    </div>
                    <!-- <div class="form-group row cibil_score_checked d-none  mb-4">
                                                <label for="cibil_score_checked" class="col-sm-4 col-form-label col-form-label-sm">CIBIL Score Checked?</label>
                                                <div class="col-sm-8">
                                                    <select class="form-control form-control-sm cibil_score_checked" name="cibil_score_checked">
                                                        <option value="1">Yes</option>
                                                        <option value="0" selected="true">No</option>
                                                    </select>
                                                </div>
                                            </div> -->
                    <div class="form-group row cibil_score_row  mb-4 @if(!$office->cibil_score)d-none @endif">
                      <label for="cibil_score_row" class="col-sm-4 col-form-label col-form-label-sm">CIBIL
                        Score</label>
                      <div class="col-sm-8">
                        <input type="text" name="cibil_score" class="form-control form-control-sm" id="cibil_score"
                          placeholder="CIBIL Score" value="{{ $office->cibil_score }}">
                      </div>
                    </div>
                    <div class="form-group row mgmt_review_row @if(!$office->managment_review_select) d-none @endif"
                      mb-4">
                      <label for="mgmt_review_row" class="col-sm-4 col-form-label col-form-label-sm">CIBIL Score
                        Management Review?</label>
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm managment_review_select"
                          name="managment_review_select">
                          <option value="1" @if($office->managment_review_select == '1') selected @endif>Approved
                          </option>
                          <option value="0" @if($office->managment_review_select == '0') selected @endif>Rejected
                          </option>
                          <option value="2" @if($office->managment_review_select == '2') selected @endif>On Hold
                          </option>
                        </select>
                      </div>
                    </div>
                    <div
                      class="form-group row cibil_score_management_review_text_row mb-4 @if(!$office->management_review_text) d-none @endif">
                      <label for="management_review_text_row" class="col-sm-4 col-form-label col-form-label-sm">CIBIL
                        Score
                        Management Review Note</label>
                      <div class="col-sm-8">
                        <textarea name="management_review_text" class="form-control form-control-sm"
                          id="management_review_text"
                          placeholder="Management Review">{{ $office->management_review_text }}</textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-group row visit_row @if(!$office->visit_select) d-none @endif mb-4">
                      <label for="visit_row" class="col-sm-4 col-form-label col-form-label-sm">Visit
                        required?</label>
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm visit_select" name="visit_select">
                          <option value="1" @if($office->visit_select == '1') selected @endif>Yes</option>
                          <option value="0" @if($office->visit_select == '0') selected @endif>No</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row visit_review_row @if(!$office->visit_review_select) d-none @endif mb-4">
                      <label for="visit_review_row" class="col-sm-4 col-form-label col-form-label-sm">Visit Management
                        Review?</label>
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm visit_review_select" name="visit_review_select">
                          <option value="1" @if($office->visit_review_select == '1') selected @endif>Approved</option>
                          <option value="0" @if($office->visit_review_select == '0') selected @endif>Rejected</option>
                          <option value="2" @if($office->visit_review_select == '2') selected @endif>On Hold</option>
                        </select>
                      </div>
                    </div>
                    <div
                      class="form-group row visit_review_text_row mb-4 @if(!$office->visit_review_text) d-none @endif">
                      <label for="visit_review_text_row" class="col-sm-4 col-form-label col-form-label-sm">Visit
                        Management
                        Review Note</label>
                      <div class="col-sm-8">
                        <textarea name="visit_review_text" class="form-control form-control-sm" id="visit_review_text"
                          placeholder="Management Review">{{ $office->visit_review_text }}</textarea>
                      </div>
                    </div>
                    <!-- <div class="form-group row visit_text_row  mb-4 d-none">
                                                <label for="visit_text_row" class="col-sm-4 col-form-label col-form-label-sm">Visit Note</label>
                                                <div class="col-sm-8">
                                                    <textarea name="visit_text" class="form-control form-control-sm" id="visit_text" placeholder="Visit Note"></textarea>
                                                </div>
                                            </div> -->
                    <div class="form-group row attend_by_row mb-4 @if(!$office->attend_by) d-none @endif">
                      <label for="attend_by" class="col-sm-4 col-form-label col-form-label-sm">Visited by</label>
                      <div class="col-sm-8">
                        <input type="text" name="attend_by" class="form-control form-control-sm" id="attend_by"
                          placeholder="Visited by" value="{{ $office->attend_by }}">
                      </div>
                    </div>
                    <div class="form-group row document_row mb-4 @if(!$office->document_select) d-none @endif">
                      <label for="document_row" class="col-sm-4 col-form-label col-form-label-sm">Documentation
                        Check?</label>
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm document_select" name="document_select">
                          <option value="1" @if($office->document_select == '1') selected @endif>Yes</option>
                          <option value="0" @if($office->document_select == '0') selected @endif>No</option>
                        </select>
                      </div>
                    </div>
                    <div
                      class="form-group row document_review_row @if(!$office->document_review_select) d-none @endif mb-4">
                      <label for="document_review_row" class="col-sm-4 col-form-label col-form-label-sm">Document
                        Management Review?</label>
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm document_review_select"
                          name="document_review_select">
                          <option value="1" @if($office->document_review_select == '1') selected @endif>Approved
                          </option>
                          <option value="0" @if($office->document_review_select == '0') selected @endif>Rejected
                          </option>
                          <option value="2" @if($office->document_review_select == '2') selected @endif>On Hold</option>
                        </select>
                      </div>
                    </div>
                    <div
                      class="form-group row document_review_text_row mb-4 @if(!$office->document_review_text) d-none @endif">
                      <label for="document_review_text_row" class="col-sm-4 col-form-label col-form-label-sm">Visit
                        Management
                        Review Note</label>
                      <div class="col-sm-8">
                        <textarea name="document_review_text" class="form-control form-control-sm"
                          id="document_review_text"
                          placeholder="Management Review">{{ $office->document_review_text }}</textarea>
                      </div>
                    </div>
                    <div
                      class="form-group row client_document_row  mb-4  @if(!$office->client_document_select) d-none @endif">
                      <label for="client_document_row" class="col-sm-4 col-form-label col-form-label-sm">Select
                        Documentation</label>
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm client_document_select"
                          name="client_document_select">
                          <option value="1" @if($office->client_document_select == '1') selected @endif>Client's
                            Document</option>
                          <option value="0" @if($office->client_document_select == '0') selected @endif>Gaurantor's
                            Document</option>
                        </select>
                      </div>
                    </div>
                    @if($office->client_documents)
                    @php
                    $resi_proof = json_decode($office->client_documents, true)['resi_proof'];
                    $busi_proof = json_decode($office->client_documents, true)['busi_proof'];
                    $id_proof = json_decode($office->client_documents, true)['id_proof'];
                    @endphp
                    @endif
                    <div class="form-group row client_document_text_row mb-4 @if($office->client_document_select != '1') d-none @endif">
                      <label for="visit_text_row" class="col-sm-4 col-form-label col-form-label-sm">Client's
                        Document</label>
                      <div class="col-sm-8">
                        <h6 class="mt-1">Residence Proof</h6>
                        <div class="n-chk">
                          <label class="new-control new-checkbox checkbox-primary">
                            <input type="checkbox" class="new-control-input" name="resi_proof[]"
                              value="index_copy_rent_aggr" @if(!empty($resi_proof) && in_array('index_copy_rent_aggr',
                              $resi_proof)) checked @endif>
                            <span class="new-control-indicator"></span>Index Copy / Rent
                            Agreement
                          </label>
                        </div>
                        <div class="n-chk">
                          <label class="new-control new-checkbox checkbox-primary">
                            <input type="checkbox" class="new-control-input" name="resi_proof[]" value="aadhar_card"
                              @if(!empty($resi_proof) && in_array('aadhar_card', $resi_proof)) checked @endif>
                            <span class="new-control-indicator"></span>Aadhar Card
                          </label>
                        </div>
                        <div class="n-chk">
                          <label class="new-control new-checkbox checkbox-primary">
                            <input type="checkbox" class="new-control-input" name="resi_proof[]" value="light_bill"
                              @if(!empty($resi_proof) && in_array('light_bill', $resi_proof)) checked @endif>
                        ...
                        <div class="n-chk">
                          <label class="new-control new-checkbox checkbox-primary">
                            <input type="checkbox" class="new-control-input" name="business_proof[]"
                              value="GST_certificate" @if(!empty($busi_proof) && in_array('GST_certificate',
                              $busi_proof)) checked @endif>
                        ...
                        <div class="n-chk">
                          <label class="new-control new-checkbox checkbox-primary">
                            <input type="checkbox" class="new-control-input" name="business_proof[]"
                              value="index_copy_rent_aggr" @if(!empty($busi_proof) && in_array('index_copy_rent_aggr',
                              $busi_proof)) checked @endif>
                            <span class="new-control-indicator"></span>Index Copy / Rent
                            Agreement
                          </label>
                        ...
                        <div class="n-chk">
                          <label class="new-control new-checkbox checkbox-primary">
                            <input type="checkbox" class="new-control-input" name="business_proof[]" value="light_bill"
                              @if(!empty($busi_proof) && in_array('light_bill', $busi_proof)) checked @endif>
                            <span class="new-control-indicator"></span>Light bill
                          </label>
                        </div>
                        <div class="n-chk">
                          <label class="new-control new-checkbox checkbox-primary">
                            <input type="checkbox" class="new-control-input" name="business_proof[]" value="tax_bill"
                              @if(!empty($busi_proof) && in_array('tax_bill', $busi_proof)) checked @endif>
                        ...
                        <div class="n-chk">
                          <label class="new-control new-checkbox checkbox-primary">
                            <input type="checkbox" class="new-control-input" name="id_proof[]" value="pan_card"
                              @if(!empty($id_proof) && in_array('pan_card', $id_proof)) checked @endif>
                            <span class="new-control-indicator"></span>PAN Card
                          </label>
                        </div>
                        <div class="n-chk">
                          <label class="new-control new-checkbox checkbox-primary">
                            <input type="checkbox" class="new-control-input" name="id_proof[]" value="photo"
                              @if(!empty($id_proof) && in_array('photo', $id_proof)) checked @endif>
                            <span class="new-control-indicator"></span>PHOTO
                          </label>
                        </div>
                      </div>
                    </div>
                    <div class="form-group row gaurantor_document_text_row mb-4 @if($office->client_document_select != '0') d-none @endif">
                      <label for="visit_text_row" class="col-sm-4 col-form-label col-form-label-sm">Gaurantor's
                        Document</label>
                      <div class="col-sm-8">
                        <h6 class="mt-1">Residence Proof</h6>
                        <div class="n-chk">
                    ...
                    <div class="form-group final_status d-none row  mb-4">
                      <label for="guarantor_affiliate_type_other"
                        class="col-sm-4 col-form-label col-form-label-sm">Status</label>
                      <div class="col-sm-8">
                        <select class="form-control form-control-sm cibil_score_type" name="cibil_score_type">
...
$(document).ready(function() {
  ...
  // For office use only form js
  $('.cibil_score_required_type').change(function() {
    if ($(this).val() == 1) {
  ...
  // End For office use only form js
