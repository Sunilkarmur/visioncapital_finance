                                ...
                                <div id="pill-vertical">
                                    ...
                                    <section>
                                        <form class="referrance-finance-detail">
                                            <div class="form-group row  mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="ref_name"
                                                           class="form-control form-control-sm" id="ref_name"
                                                           placeholder="Name of Person"
                                                           value="{{ $finance->ref_name }}">
                                                </div>
                                            </div>
                                            <div class="form-group row  mb-4">
                                                <label for="ref_firm" class="col-sm-4 col-form-label col-form-label-sm">Name
                                                    of Firm</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="ref_firm"
                                                           class="form-control form-control-sm" id="ref_firm"
                                                           placeholder="Name of Firm" value="{{ $finance->ref_firm }}">
                                                </div>
                                            </div>
                                            <div class="form-group row  mb-4">
                                                <label for="ref_contact"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Mobile
                                                    No</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="ref_contact"
                                                           class="form-control form-control-sm" id="ref_contact"
                                                           placeholder="Mobile No" value="{{ $finance->ref_contact }}">
                                                </div>
                                            </div>
                                            <div class="form-group row  mb-4">
                                                <label for="ref_affiliate_vc"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Affliated to
                                                    Vision Capital</label>
                                                <div class="col-sm-8">
                                                    <select class="form-control form-control-sm ref_affiliate_vc"
                                                            name="ref_affiliate_vc">
                                                        <option
                                                            value="Yes" {{ $finance->ref_affiliate_vc==="Yes"?"selected='selected'":"" }}>
                                                            Yes
                                                        </option>
                                                        <option
                                                            value="No" {{ $finance->ref_affiliate_vc==="No"?"selected='selected'":"" }}>
                                                            No
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row  mb-4 d-none select_affiliate_type">
                                                <label for="ref_affiliate_type"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Select
                                                    Affliated
                                                    Type</label>
                                                <div class="col-sm-8">
                                                    <select class="form-control form-control-sm ref_affiliate_type"
                                            ...
                                            <div class="form-group row  mb-4 d-none specify">
                                                <label for="ref_affiliate_type_other"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Specify
                                                    here</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="ref_affiliate_type_other"
                                    ...
                                    <section>
                                        <form id="borrower-detail-form">
                                            <div class="form-group row  mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="bor_name"
                                                           class="form-control form-control-sm" id="bor_name"
                                                           placeholder="Name" value="{{ $finance->bor_name }}">
                                                </div>
                                            </div>
                                            <div class="form-group row  mb-4">
                                                <label for="bor_amount"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Amount
                                                    Required</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="bor_amount"
                                                           class="form-control form-control-sm" id="bor_amount"
                                                           placeholder="Amount Required"
                                                           value="{{ $finance->bor_amount }}">
                                                </div>
                                            </div>
                                            <div class="form-group row  mb-4">
                                                <label for="bor_time_limit"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Time
                                                    Limit</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="bor_time_limit"
                                                           class="form-control form-control-sm"
                                                           id="bor_time_limit" placeholder="Time Limit"
                                                           value="{{ $finance->bor_time_limit }}">
                                                </div>
                                            </div>
                                            <div class="form-group row  mb-4">
                                                <label for="bor_purpose"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Purpose</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="bor_purpose"
                                                           class="form-control form-control-sm" id="bor_purpose"
                                                           placeholder="Purpose" value="{{ $finance->bor_purpose }}">
                                                </div>
                                            </div>
                                            <div class="form-group row  mb-4">
                                                <label for="bor_affiliate_vc"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Affliated to
                                                    Vision Capital</label>
                                                <div class="col-sm-8">
                                                    <select class="form-control form-control-sm bor_affiliate_vc"
                                                            name="bor_affiliate_vc">
                                                        <option
                                                            value="Yes" {{ $finance->bor_affiliate_vc==='Yes'?'selected="selected"':'' }}>
                                                            Yes
                                                        </option>
                                                        <option
                                                            value="No" {{ $finance->bor_affiliate_vc==='No'?'selected="selected"':'' }}>
                                                            No
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row  mb-4 d-none bor_select_affiliate_type">
                                                <label for="bor_affiliate_type"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Select
                                                    Affliated
                                                    Type</label>
                                                <div class="col-sm-8">
                                                    <select class="form-control form-control-sm bor_affiliate_type"
                                                            name="bor_affiliate_type">
                                                        <option
                                                            value="Loan" {{ $finance->bor_affiliate_type==='Loan'?'selected="selected"':'' }}>
                                                            Loan
                                                        </option>
                                                        ...
                                                        <option
                                                            value="VC" {{ $finance->bor_affiliate_type==='VC'?'selected="selected"':'' }}>
                                                            VC
                                                        </option>
                                                        <option
                                                            value="Other" {{ $finance->bor_affiliate_type==='Other'?'selected="selected"':'' }}>
                                                            Other (Specify)
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row  mb-4 d-none bor_specify">
                                                <label for="bor_affiliate_type_other"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Specify
                                                    here</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="bor_affiliate_type_other"
                                                           class="form-control form-control-sm"
                                            ...
                                            <div class="form-group row  mb-4">
                                                <label for="bor_pan_no"
                                                       class="col-sm-4 col-form-label col-form-label-sm">PAN No.</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="bor_pan_no"
                                                           class="form-control form-control-sm" id="bor_pan_no"
                                                           placeholder="PAN No." value="{{ $finance->bor_pan_no }}">
                                                </div>
                                            </div>
                                            <div class="form-group row  mb-4">
                                                <label for="bor_aadhar_no"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Adhar
                                                    No.</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="bor_aadhar_no" data-type="adhaar-number"
                                                           class="form-control form-control-sm" id="bor_aadhar_no"
                                                           placeholder="Adhar No."
                                                           value="{{ $finance->bor_aadhar_no }}">
                                                </div>
                                            </div>
                                            <div class="form-group row  mb-4">
                                                <label for="bor_pin_code"
                                                       class="col-sm-4 col-form-label col-form-label-sm">PIN
                                                    Code</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="bor_pin_code"
                                                           class="form-control form-control-sm" id="bor_pin_code"
                                            ...
                                            <div class="form-group row  mb-4">
                                                <label for="bor_dob" class="col-sm-4 col-form-label col-form-label-sm">Date
                                                    of Birth</label>
                                                <div class="col-sm-8">
                                                    <input type="date" name="bor_dob"
                                                           class="form-control form-control-sm" id="bor_dob"
                                                    ...
                                                    <form class="business_detail_form">
                                                        ...
                                                        <div class="form-group row  mb-4">
                                                            <label for="business_name"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Name
                                                                of
                                                                Firm</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="business_name"
                                                                       class="form-control form-control-sm"
                                                                       id="business_name" placeholder="Name of Firm"
                                                                       required
                                                                       value="{{ $value->business_name }}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row  mb-4">
                                                            <label for="business_started_date"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Started
                                                                on</label>
                                                            <div class="col-sm-8">
                                                                <input type="date" name="business_started_date"
                                                                       class="form-control form-control-sm"
                                                        ...
                                                        <div class="form-group row  mb-4">
                                                            <label for="business_type"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Type</label>
                                                            <div class="col-sm-8">
                                                                <select
                                                                    class="form-control form-control-sm business_type"
                                                                    name="business_type">
                                                        ...
                                                        <div class="form-group promoter_name_row d-none row  mb-4">
                                                            <label for="business_nature"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Main
                                                                Promoter
                                                                Name</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="promoter_name"
                                                                       class="form-control form-control-sm"
                                                                       id="promoter_name"
                                                                       placeholder="Main Promoter Name"
                                                                       value="{{ $value->promoter_name }}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row  mb-4">
                                                            <label for="business_nature"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Nature
                                                                /
                                                                Activity</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="business_nature"
                                                                       class="form-control form-control-sm"
                                                                       id="business_nature"
                                                                       placeholder="Nature / Activity"
                                                                       value="{{ $value->business_nature }}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row  mb-4">
                                                            <label for="business_monthly_income"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Monthly
                                                                Income</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="business_monthly_income"
                                                                       class="form-control form-control-sm"
                                                        ...
                                                        <div class="form-group row  mb-4">
                                                            <label for="total_no_machines"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Total
                                                                no. of
                                                                Machines</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="total_no_machines"
                                                                       class="form-control form-control-sm"
                                                                       id="total_no_machines"
                                                                       placeholder="Total No. of Machines"
                                                                       value="{{ $value->total_no_machines }}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row  mb-4">
                                                            <label for="total_no_employees"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Total
                                                                no. of
                                                                Employees</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="total_no_employees"
                                                                       class="form-control form-control-sm"
                                                                       id="total_no_employees"
                                                                       placeholder="Total No. of Employees"
                                                                       value="{{ $value->total_no_employees }}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row  mb-4">
                                                            <label for="monthly_turnover"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Turnover
                                                                (Monthly)</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="monthly_turnover"
                                                                       class="form-control form-control-sm"
                                                                       id="monthly_turnover"
                                                                       placeholder="Turnover (Monthly)"
                                                                       value="{{ $value->monthly_turnover }}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row  mb-4">
                                                            <label for="business_location"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Location
                                                                /
                                                                Address</label>
                                                            <div class="col-sm-8">
                                                        ...
                                                        <div class="form-group row  mb-4">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <select
                                                                    class="form-control form-control-sm business_location_type"
                                                        ...
                                                        <div class="form-group row  mb-4">
                                                            <label for="business_duration_place"
                                                                ...
                                                                at that place:</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="business_duration_place"
                                                                       class="form-control form-control-sm"
                                                                       id="business_duration_place"
                                                                       placeholder="Duration at that place:"
                                    ...
                                    <section>
                                        <form id="residence-detail">
                                            <div class="form-group row  mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="home_address"
                                                           class="form-control form-control-sm" id="home_address"
                                                           placeholder="Location / Address"
                                                           value="{{ $finance->home_address }}">
                                                </div>
                                            </div>
                                            <div class="form-group row  mb-4">
                                                <label for="home_type"
                                                    ...
                                                    Type</label>
                                                <div class="col-sm-8">
                                                    <select class="form-control form-control-sm home_type"
                                                            name="home_type">
                                                        <option value="Own"
                                                                selected="{{ $finance->home_type==="Own"?'selected':'' }}">
                                                            Own
                                                        </option>
                                                        <option value="Rented"
                                                                selected="{{ $finance->home_type==="Rented"?'selected':'' }}">
                                                            Rented
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row  mb-4">
                                                <label for="home_duration_place"
                                                       class="col-sm-4 col-form-label col-form-label-sm">Duration at
                                                    that place:</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="home_duration_place"
                                                           class="form-control form-control-sm"
                                                           id="home_duration_place"
                                                           placeholder="Duration at that place:"
                                        ...
                                        <div class="banking_finance_clone_row">
                                            @foreach($finance->financeBanking as $key=>$value)
                                                <form class="banking_finance_form">
                                                    ...
                                                    <div class="form-group row  mb-4">
                                                        <label for="previous_lona_type"
                                                               class="col-sm-4 col-form-label col-form-label-sm">Type</label>
                                                        <div class="col-sm-8">
                                                            <select name="previous_lona_type"
                                                                    class="form-control form-control-sm previous_lona_type">
                                                                <option value="1"
                                                                        selected={{ $value->previous_lona_type==='1'?"selected":'selected' }}>
                                                                    Home
                                                                    Loan
                                                                </option>
                                                                <option value="2"
                                                                        selected={{ $value->previous_lona_type==='2'?"selected":'selected' }}>
                                                                    Personal Loan
                                                                </option>
                                                                <option value="3"
                                                                        selected={{ $value->previous_lona_type==='3'?"selected":'selected' }}>
                                                                    Business Loan
                                                                </option>
                                                                <option value="4"
                                                                        selected={{ $value->previous_lona_type==='4'?"selected":'selected' }}>
                                                                    Machinary Loan
                                                                </option>
                                                                <option value="5"
                                                                        selected={{ $value->previous_lona_type==='5'?"selected":'selected' }}>
                                                                    Vehicle Loan
                                                                </option>
                                                                <option value="6"
                                                                        selected={{ $value->previous_lona_type==='6'?"selected":'selected' }}>
                                                                    Gold
                                                                    Loan
                                                                </option>
                                                                <option value="7"
                                                                        selected={{ $value->previous_lona_type==='7'?"selected":'selected' }}>
                                                                    CC
                                                                    Loan
                                                                </option>
                                                            </select>
                                                    ...
                                                    <div class="form-group row  mb-4">
                                                        <label for="bank_name"
                                                               class="col-sm-4 col-form-label col-form-label-sm">Bank</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group row  mb-4">
                                                        <label for="bank_branch"
                                                               class="col-sm-4 col-form-label col-form-label-sm">Branch</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" name="bank_branch"
                                                                   class="form-control form-control-sm" id="bank_branch"
                                                                   placeholder="Branch"
                                                    ...
                                                    <div class="form-group row  mb-4">
                                                        <label for="loan_amount"
                                                               class="col-sm-4 col-form-label col-form-label-sm">Loan
                                                            Amount</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" name="loan_amount"
                                                                   class="form-control form-control-sm" id="loan_amount"
                                                                   placeholder="Loan Amount"
                                                                   value="{{ $value->loan_amount }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row  mb-4">
                                                        <label for="emi_amount"
                                                               class="col-sm-4 col-form-label col-form-label-sm">EMI
                                                            Amount</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" name="emi_amount"
                                                                   class="form-control form-control-sm" id="emi_amount"
                                                    ...
                                                    <div class="form-group row  mb-4">
                                                        <label for="bank_balance"
                                                               class="col-sm-4 col-form-label col-form-label-sm">Outstanding
                                                            Amount</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" name="bank_balance"
                                                                   class="form-control form-control-sm"
                                                                   id="bank_balance"
                                                                   placeholder="Balance Amount"
                                                                   value="{{ $value->bank_balance }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row  mb-4">
                                                        <label for="duration"
                                                               class="col-sm-4 col-form-label col-form-label-sm">Duration</label>
                                                        <div class="col-sm-8">
                                        ...
                                        <div class="saving_ac_row">
                                            @foreach($finance->savingBanking as $value)
                                                <form class="saving_ac_bank_form">
                                                    ...
                                                    <div class="form-group row  mb-4">
                                                        <label for="saving_ac_bank "
                                                               class="col-sm-4 col-form-label col-form-label-sm">Savings
                                                            Account
                                                            Bank</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" name="saving_ac_bank"
                                                                   class="form-control form-control-sm"
                                                                   id="saving_ac_bank"
                                                                   placeholder="Savings Account Bank"
                                                                   value="{{ $value->bank_name }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row  mb-4">
                                                        <label for="saving_ac_branch"
                                                               class="col-sm-4 col-form-label col-form-label-sm">Savings
                                                            Account
                                                            Branch</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" name="saving_ac_branch"
                                                                   class="form-control form-control-sm"
                                                                   id="saving_ac_branch"
                                                                   placeholder="Savings Account Branch"
                                        ...
                                        <div class="current_account_row">
                                            @foreach($finance->currentBanking as $value)
                                                <form class="current_ac_bank_form">
                                                    ...
                                                    <div class="form-group row  mb-4">
                                                        <label for="current_ac_bank"
                                                               class="col-sm-4 col-form-label col-form-label-sm">Current
                                                            Account
                                                            Bank</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" name="current_ac_bank"
                                                                   class="form-control form-control-sm"
                                                                   id="current_ac_bank"
                                                                   placeholder="Current Account Bank"
                                                                   value="{{ $value->bank_name }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row  mb-4">
                                                        <label for="current_ac_branch"
                                                               class="col-sm-4 col-form-label col-form-label-sm">Current
                                                            Account
                                                            Branch</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" name="current_ac_branch"
                                                                   class="form-control form-control-sm"
                                                                   id="current_ac_branch"
                                                                   placeholder="Current Account Branch"
                                                                   value="{{ $value->branch_name }}">
                                                        </div>
                                                    </div>
                                                </form>
                                            ...
                                            @if($guarantor_detail)
                                                @foreach($guarantor_detail as $value)
                                                    <form class="guarantor_section_form">
                                                        ...
                                                        <div class="form-group row  mb-4">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" name="guarantor_name"
                                                                       class="form-control form-control-sm"
                                                                       id="guarantor_name" placeholder="Name of Person"
                                                                       value="{{ $value->guarantor_firm }}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row  mb-4">
                                                            <label for="guarantor_firm"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Name
                                                                of
                                                                Firm</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="guarantor_firm"
                                                                       class="form-control form-control-sm"
                                                                       id="guarantor_firm" placeholder="Name of Firm"
                                                                       value="{{ $value->guarantor_firm }}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row  mb-4">
                                                            <label for="guarantor_firm_nature"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Nature
                                                                /Activity of Firm</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="guarantor_firm_nature"
                                                                       class="form-control form-control-sm"
                                                                       id="guarantor_firm_nature"
                                                                       placeholder="Nature /Activity of Firm"
                                                        ...
                                                        <div class="form-group row  mb-4">
                                                            <label for="guarantor_affiliate_vc"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Affliated
                                                                to Vision Capital</label>
                                                            <div class="col-sm-8">
                                                                <select
                                                                    class="form-control form-control-sm guarantor_affiliate_vc"
                                                                    name="guarantor_affiliate_vc">
                                                                    <option value="1"
                                                                            selected="{{ $value->guarantor_affiliate_vc==='1'?'selected':'' }}">
                                                                        Yes
                                                                    </option>
                                                                    <option value="0"
                                                                            selected="{{ $value->guarantor_affiliate_vc==='0'?'selected':'' }}">
                                                                        No
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="form-group row  mb-4 d-none affiliate_type">
                                                            <label for="guarantor_affiliate_type"
                                                                   class="col-sm-4 col-form-label col-form-label-sm">Select
                                                                Affliated Type</label>
                                                            <div class="col-sm-8">
                                                                <select
                                                                    class="form-control form-control-sm guarantor_affiliate_type[]"
                                                        ...
                                                        <div class="form-group row  mb-4 d-none guarantor_specify">
                                                            <label for="guarantor_affiliate_type_other"
                                                                ...
                                                                here</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" name="guarantor_affiliate_type_other"
                                                                       class="form-control form-control-sm"
                                                                       id="guarantor_affiliate_type_other"
                                                                       placeholder="Other"
                                    ...
                                    <section>
                                        <form class="officeuse_section_form">
                                            ...
                                            <div class="form-group row cibil_score_management_review_text_row mb-4 d-none">
                                            ...
                                            <div class="form-group row visit_review_text_row d-none  mb-4 d-none">
                                                <label for="visit_review_text_row" class="col-sm-4 col-form-label col-form-label-sm">Visit Management Review Note</label>
                                                <div class="col-sm-8">
                                                    <textarea name="visit_review_text" class="form-control form-control-sm" id="visit_review_text" placeholder="Management Review"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row attend_by_row d-none  mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="attend_by" class="form-control form-control-sm" id="attend_by" placeholder="Visited by"></textarea>
                                                </div>
                                            </div>
