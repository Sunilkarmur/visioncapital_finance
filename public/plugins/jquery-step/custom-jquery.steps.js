...
function officeUseForm(currentIndex) {
    var form = $('.officeuse_section_form');
    var office_use_form = validation(form, {
        remarks: "required",
        cibil_socre_required_type: "required",
        cibil_socre: "required",
        managment_review_select: "required",
        management_review_text: "required",
        visit_select: "required",
        visit_review_select: "required",
        visit_review_text: "required",
        attend_by: "required",
        document_select: "required",
        document_review_select: "required",
        document_review_text: "required",
        client_document_select: "required",
    }, {
        remarks: "Please enter remarks",
        cibil_socre_required_type: "Please select cibil score type",
        cibil_socre: "Please enter cibil score",
        managment_review_select: "Please select management review type",
        management_review_text: "Please enter cibil score management review note",
        visit_select: "Please select visit type",
        visit_review_select: "Please select visit management review",
        visit_review_text: "Please enter visit management review note",
        attend_by: "Please enter visited by",
        document_select: "Please select documentation type",
        document_review_select: "Please select document management review",
        document_review_text: "Please enter visit management review note",
        client_document_select: "Please select documentation",
    }, false)
    if (!office_use_form) {
        return office_use_form;
    }
    var id = $('#finance-form-id').val();
    if (id) {
        office_use_form.push({ name: 'id', value: id });
    }
    var status = false;
    return addFormData(currentIndex, office_use_form, function (response) {
